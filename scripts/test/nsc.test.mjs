...
import { parseNscWorkbook, buildNscUrl, buildNscUrlCandidates, isoWeek, previousWeek, fetchNscPrices } from '../lib/nsc.mjs';
import { priceFor } from '../../src/prices/prices.ts';
